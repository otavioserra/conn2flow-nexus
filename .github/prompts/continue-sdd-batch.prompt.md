...
description: Retoma trabalho no batch atual do Conn2Flow Nexus sem perder o contexto dos sdd e artefatos incrementais.
...
Se a atualizacao vier como caminho em `sdd/human-requests/`, releia primeiro esse intake humano. Se vier apenas a pasta, use `CURRENT.md`, depois `README.md`, depois o `.md` mais recente.
